  ...
  return (
    <Fragment>
      <form className='form' onSubmit={handleSubmit(onSubmit)}>
        ...
        <input name='phone' className='field' placeholder='Phone Number*' type='number' defaultValue='' required {...register('phone', {required: true})} />
        ...
        <input name='company' className='field field-50' placeholder='Business/Organization name*' type='text' defaultValue='' required {...register('company', {required: true})} />
        ...
        <textarea name='description' placeholder='Tell us how we can help' />
      </form>
